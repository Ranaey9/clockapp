...
function saatDegistir(fark) { saat = (saat + fark + 24) % 24; saatiGoster(); }
function dakikaDegistir(fark) { dakika = (dakika + fark + 60) % 60; saatiGoster(); }
...
document.querySelector(".save-btn").onclick = () => {
  const alarm = {
    ...
    not: document.getElementById("label").value || "Alarm",
